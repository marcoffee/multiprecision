...
public:
    ...
    BOOST_MP_ALLOC_CONSTEXPR empty_value() = default;
    explicit BOOST_MP_ALLOC_CONSTEXPR empty_value(boost::multiprecision::detail::empty_init_t)
        : value_ {} {}

    template <typename U, typename... Args>
    BOOST_MP_ALLOC_CONSTEXPR empty_value(boost::multiprecision::detail::empty_init_t, U&& value, Args&&... args)
        : value_ {std::forward<U>(value), std::forward<Args>(args)...} {}

    BOOST_MP_ALLOC_CONSTEXPR const T& get() const noexcept { return value_; }
    BOOST_MP_ALLOC_CONSTEXPR T& get() noexcept { return value_; }
};
...
public:
    ...
    BOOST_MP_ALLOC_CONSTEXPR const T& get() const noexcept { return *this; }
    BOOST_MP_ALLOC_CONSTEXPR T& get() noexcept { return *this; }
};
